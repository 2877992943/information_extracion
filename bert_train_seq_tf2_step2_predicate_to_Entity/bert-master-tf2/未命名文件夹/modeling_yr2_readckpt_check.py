...
if __name__=='__main__':
    ...
    ####
    w0 = bertEncode.embedding_lookup_l.embedding_table # 0.0004
    ### restore
    ckpt = tensorflow.train.Checkpoint(net=bertEncode) # w0=0.026
    checkpoint_path = '../model_encode_ckpt/'
    ckpt.restore(tf.train.latest_checkpoint(checkpoint_path))

    #### see current status
    w1 = bertEncode.embedding_lookup_l.embedding_table


    m18 = bertEncode.get_tranformer_layer.layer3.norm_l_layer_output
    w_status1 = from_submodel_get_weights(m18)
    print('')
