  ...
  def __init__(self,
    ...
    with tf.compat.v1.variable_scope(scope, default_name="bert"):
      with tf.compat.v1.variable_scope("embeddings"):
        ...
        self.embedding_table = embedding_lookup_init(
            #input_ids=input_ids,
        ...
        ### move to call
        self.embedding_output=embedding_lookup_impl(
            input_ids,
        ...
        self.token_type_table,self.full_position_embeddings = embedding_postprocessor_init(
        ...
        ### move to call
        self.embedding_output=embedding_postprocessor_impl(self.embedding_output,
                                     use_token_type=True,
                                     token_type_ids=token_type_ids,
                                     token_type_table=self.token_type_table,
                                     layer_norm_and_dropout=self.embedding_norm_drop,
      ...
      with tf.compat.v1.variable_scope("encoder"):
        ...
        self.all_layer=get_tranformer_layer(input_shape=[batch_size,seq_length,config.hidden_size],
...
def embedding_postprocessor_init(input_shape,
  ...
  token_type_table, full_position_embeddings=None,None
  ...
  # return output
    return token_type_table,full_position_embeddings


def embedding_postprocessor_impl(input_tensor,
                            use_token_type=False,
                            token_type_ids=None,
                            token_type_table=None,
                            layer_norm_and_dropout=None,
    ...
    with tf.compat.v1.variable_scope("layer_%d" % layer_idx):
      ...
      with tf.compat.v1.variable_scope("attention"):
        ...
        with tf.compat.v1.variable_scope("self"):
          ...
          this_l=[query_layer_l,key_layer_l,value_layer_l]
        ...
        with tf.compat.v1.variable_scope("output"):
          ...
          norm_l=Norm()
          this_l.append(dense_l_out)
          this_l.append(norm_l)
      ...
      with tf.compat.v1.variable_scope("intermediate"):
        ...
        this_l.append(dense_l_intermediate)
      ...
      with tf.compat.v1.variable_scope("output"):
        ...
        this_l.append(dense_l_out2)
        this_l.append(norm_l_layer_output)
    ######
    all_layer.append(this_l)
  return all_layer



def transformer_model(all_layer,
                        input_tensor,
                      attention_mask=None,
                      hidden_size=768,
                      num_hidden_layers=12,
    ...
    with tf.compat.v1.variable_scope("layer_%d" % layer_idx):
      ...
      with tf.compat.v1.variable_scope("attention"):
        ...
        with tf.compat.v1.variable_scope("self"):
          ...
          #                       units=num_attention_heads * attention_head_size,
          #                       )
          query_layer_l=this_l[0]
          key_layer_l=this_l[1]
          value_layer_l=this_l[2]
        ...
        with tf.compat.v1.variable_scope("output"):
          # dense_l_out=Dense(kernel_initializer=create_initializer(initializer_range),
          #                   units=hidden_size)
          dense_l_out=this_l[3]
          attention_output=dense_l_out(attention_output)
          ...
          #norm_l=Norm()
          norm_l=this_l[4]
          attention_output=norm_l(attention_output + layer_input)
      ...
      with tf.compat.v1.variable_scope("intermediate"):
        ...
        #                            units=intermediate_size,
        #                            activation=intermediate_act_fn)
        dense_l_intermediate=this_l[5]

        intermediate_output=dense_l_intermediate(attention_output)
      ...
      with tf.compat.v1.variable_scope("output"):
        ...
        # dense_l_out2=Dense(kernel_initializer=create_initializer(initializer_range),
        #                    units=hidden_size)
        dense_l_out2=this_l[6]
        layer_output=dense_l_out2(intermediate_output)


        layer_output = dropout(layer_output, hidden_dropout_prob)
        #norm_l_layer_output = Norm() ##
        norm_l_layer_output=this_l[7]
        layer_output=norm_l_layer_output(layer_output + attention_output)
