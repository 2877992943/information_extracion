...
def convert_examples_to_features1(examples,
  ...
  for (example_index, example) in enumerate(examples):
    ...
    if len(yseq_token) > max_seq_length_y: # 限制长度
...
if __name__ == "__main__":
  ...
  FLAGS.target_vocab=os.path.join(XIAOBAI_DATA_DIR,'dict_v1231','rela_78.dict')

  FLAGS.target_vocab_size = 78
  ### pos vocab
  ...
  FLAGS.max_seq_length_y=76 # 比最长75多
