...
if __name__ == "__main__":
  ...
  FLAGS.train_file=os.path.join(XIAOBAI_DATA_DIR,'tmp',f1[0])  # no use
  ...
  FLAGS.save_checkpoints_steps = 200
  ...
  FLAGS.max_seq_length_y=76 # max75
  ...
  print_freq=2 # print loss frequency
