...
train_data = load_data('../spo_data/t50.json')
valid_data = load_data('../spo_data/t50.json')
...
def evaluate(data):
    ...
    f = codecs.open('/models/allField_train_test_architecture_origin/dev_pred.json', 'w', encoding='utf-8')
    pbar = tqdm()
    for d in data:
...
if __name__ == '__main__':
    ...
    train_model.save_weights('/models/allField_train_test_architecture_origin/best_model.weights')
